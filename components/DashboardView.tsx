  ...
  return (
    <div className="space-y-6 pb-12 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className={`${cardBg} rounded-2xl p-5 relative min-w-0 overflow-hidden`}>
          ...
          <div className="flex items-baseline justify-between mt-1 gap-2 flex-wrap">
            <h2 className={`text-lg sm:text-xl lg:text-2xl font-bold ${textMain} tracking-tight font-mono break-all max-w-full`}>
        ...
        <div className={`${cardBg} rounded-2xl p-5 min-w-0 overflow-hidden`}>
          <p className={`text-xs ${textSub} font-medium mb-1 truncate`}>24H Realized P&L</p>
          <div className="flex items-baseline justify-between gap-2 flex-wrap">
            <h2 className={`text-lg sm:text-xl lg:text-2xl font-bold tracking-tight font-mono break-all max-w-full ${isOwner ? 'text-emerald-500 dark:text-emerald-400' : textMain}`}>{isOwner ? '+' : ''}{dailyPnL.symbol} {dailyPnL.formatted}</h2>
        ...
        <div className={`${cardBg} rounded-2xl p-5 min-w-0 overflow-hidden sm:col-span-2 lg:col-span-1`}>
          <p className={`text-xs ${textSub} font-medium mb-1 truncate`}>Security Status</p>
          <div className="flex items-baseline justify-between gap-2 flex-wrap">
            <h2 className={`text-lg sm:text-xl lg:text-2xl font-bold ${textMain} tracking-tight font-mono break-all`}>{user.securityScore}/100</h2>
